...
class pytorchTransformerLM_mse(nn.Module):
    def __init__(self, num_tokens, max_seq_len, dim, depth, heads, ff_mult=4, emb_dropout=0.0, g2v_position_emb=False):
        ...
        self.encoder_layer = nn.TransformerEncoderLayer(d_model=dim, nhead=heads, dim_feedforward=dim * ff_mult)
